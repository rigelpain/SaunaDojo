        ...
        <v-row align="center" class="ma-1">
          <v-col flex>
            ...
            >
              <img
                alt="Avatar"
                src="https://avataaars.io/?avatarStyle=Transparent&topType=ShortHairShortRound&accessoriesType=Sunglasses&hairColor=SilverGray&facialHairType=MoustacheFancy&facialHairColor=BrownDark&clotheType=GraphicShirt&clotheColor=PastelRed&graphicType=Skull&eyeType=Wink&eyebrowType=SadConcerned&mouthType=Grimace&skinColor=Tanned"
              >
            </v-avatar>
            <strong class="ml-2">Nakaoka</strong>
            <span class="ml-5 text-caption info--text">56.2kg</span>
            <span class="ml-5 text-caption info--text">165cm</span>
          </v-col>
          ...
          <v-row>
            ...
            <v-col cols="8" class="d-flex justify-space-around">
              ...
              <div class="d-flex">
                ...
                <div class="ml-2">
                  <li>
                    <v-icon small class="d-flex align-center" color="water">fas fa-tint</v-icon>
                  </li>
                  <li>
                    <span class="font-weight-light">分</span>
                  </li>
...
export default {
  data () {
      return {
        ...
        isPlaying: true,
        follow: false,
        sauna_01: require("~/static/images/sauna/sauna_07.jpg"),
      }
    },
  computed: {
  }
